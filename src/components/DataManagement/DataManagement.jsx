  ...
  return (
    <div className='data' id='data'>
        ...
        <div className='data-group-mobile'>
            ...
            <div className='data-group-2'>
                <p className='parrafo1'>Los datos de tu empresa pueden ser uno de tus activos mas valiosos, si los usas correctamente.</p>
                <p className='parrafo2'>Te ayudamos a integrar, transformar, estructurar y limpiar tus datos para que sean utilizables para el analisis y puedas realizar su potencial</p>
            </div>
        </div>
